 ...
 * @property integer $alertaInasistencias
 */
class Configuracion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('alertaInasistencias', 'required'),
			array('alertaInasistencias', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idConfiguracion, alertaInasistencias', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'alertaInasistencias' => 'Alerta Inasistencias',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('alertaInasistencias',$this->alertaInasistencias);
