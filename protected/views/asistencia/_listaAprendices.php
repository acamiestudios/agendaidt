...
if( count($model) ){
    echo CHtml::beginForm('guardarAsistencias','post',array('name'=>'listaAprendices','id'=>'listaAprendices_form'));
        ...
        echo CHtml::hiddenField('listaAprendices[idFicha]',$idFicha);
                ...
                <?php 
                    ...
                    foreach($model as $num => $aprendiz){
                        ...
                        <tr>
                            ...
                            <td><?php echo CHtml::radioButton('listaAprendices[asistio]['. $aprendiz->idAprendiz . ']',$siAsistio,array('value'=>'0','uncheckValue'=>null));?></td>
                            <td><?php echo CHtml::radioButton('listaAprendices[asistio]['. $aprendiz->idAprendiz . ']',$noAsistio,array('value'=>'1','uncheckValue'=>null));?></td>
                        </tr>
                        <?php
                    }
