...
class EFullCalendar extends CWidget
{
    ...
    protected function registerFiles()
    {
        ...
        $ext=defined('YII_DEBUG') && YII_DEBUG ? 'min.js' : 'js';
        ...
        $cs->registerScriptFile($assets.'/fullcalendar/lib/moment.'.$ext);
//        $cs->registerScriptFile($assets.'/fullcalendar/lib/jquery.'.$ext);
