...
<?php echo Yii::app()->user->ui->getFieldAdminCreateLink(CrugeTranslator::t('nuevo Campo <i class="glyphicon glyphicon-plus"></i>'),array('class'=>'btn btn-success pull-right')); ?>
<br>
<?php 
$cols = array();
