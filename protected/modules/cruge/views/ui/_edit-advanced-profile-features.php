	...
	*/
    ...
    ?>
    <div class="well">
        <h3><?php echo ucfirst(CrugeTranslator::t("opciones avanzadas"));?></h3>
        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                <div class="text-center">
                    ...
                    if($model->state == CRUGEUSERSTATE_NOTACTIVATED){?>
                            ...
                            <?php echo ucfirst(	CrugeTranslator::t("esta accion creara una nueva clave.") );?></p>
                            <?php 
                    }else{ ?>
                        <input type='button' 
            ...
            ?>	
            <div class="form-group">
                <h3 class="text-center"><?php echo ucfirst(CrugeTranslator::t("asignacion de roles"));?></h3>
                <p class='hind text-center'>
