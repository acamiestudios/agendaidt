...
class CrugeUi extends CComponent
{
    ...
    public function getFieldAdminCreateLink($label = null,$htmlOptios=array())
    {
        if ($label === null) {
            $label = 'Create Field';
        }
        return CHtml::link(CrugeTranslator::t('admin', $label), self::getFieldsAdminCreateUrl(),$htmlOptios);
    }
    ...
    */
    ...
    public function bbutton($texto, $name = 'volver', $class='')
    {
        $this->_button($texto, $name,$class);
    }
    ...
    private function _button($label, $name = null, $class = 'btn btn-success')
    {
        $ar = array();
        ...
        $ar = array('name' => $name, 'class'=>$class);
